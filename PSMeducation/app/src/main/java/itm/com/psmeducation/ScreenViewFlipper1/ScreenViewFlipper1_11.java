 ...
 * @author Mike
 */
public class ScreenViewFlipper1_11 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper1_11(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper1_11(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview1_11, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout1_11);
		flipper = (ViewFlipper) findViewById(R.id.flipper1_11);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			switch (i) {
				case 0 : curView.setText("-실천 방법 \n (1) 선결조건\n" +
						" ⓵ 경영자의 실행의지 확보\n" +
						" ⓶ 자체감사 시행기준 수립(권한부여, 사후조치기준)\n" +
						" ⓷ 외부기관 교육수강 등을 통한 사내 자체감사 전문가 확보\n" +
						"(2) 추진사항\n" +
						" ⓵ 정기적인 자체감사 계획 수립·실시\n" +
