 ...
 * @author Mike
 */
public class ScreenViewFlipper2_2 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper2_2(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper2_2(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview2_2, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout2_2);
		flipper = (ViewFlipper) findViewById(R.id.flipper2_2);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			m_imageView.setImageResource(R.drawable.img2_2);
			mAttacher = new PhotoViewAttacher(m_imageView);
			mAttacher.setScaleType(ScaleType.FIT_XY);
			switch (i) {
				case 0 :  flipper.addView(m_imageView); break;
			}
