 ...
 * @author Mike
 */
public class ScreenViewFlipper2_5 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper2_5(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper2_5(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview2_5, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout2_5);
		flipper = (ViewFlipper) findViewById(R.id.flipper2_5);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			m_imageView.setImageResource(R.drawable.img2_5);
