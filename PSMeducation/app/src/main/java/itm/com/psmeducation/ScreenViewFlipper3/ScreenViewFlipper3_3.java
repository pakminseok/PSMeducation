 ...
 * @author Mike
 */
public class ScreenViewFlipper3_3 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper3_3(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper3_3(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview3_3, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout3_3);
		flipper = (ViewFlipper) findViewById(R.id.flipper3_3);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			m_imageView.setImageResource(R.drawable.img3_3);
