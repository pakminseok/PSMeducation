 ...
 * @author Mike
 */
public class ScreenViewFlipper5_1 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper5_1(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper5_1(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview5_1, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout5_1);
		flipper = (ViewFlipper) findViewById(R.id.flipper5_1);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			switch (i) {
				case 0 : curView.setText("1. 업무수행시 공정안전자료는 무엇이며, 어떻게 활용하고 있는가?\n" +
						"공정안전자료는 회사에서 저장 취급하는 유해 위험물질의 MSDS, 유해 위험설비 목록, 제조공정도면(FFD), 설비도면(P&ID)등 공장의 안전운전에 필요한 사업장 내의 모든 정보를 말하며, 사무실에 공정안전보고서가 비치되어 필요한 자료는 항상 열람할 수 있다.\n"); break;
			}
