 ...
 * @author Mike
 */
public class ScreenViewFlipper5_10 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper5_10(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper5_10(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview5_10, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout5_10);
		flipper = (ViewFlipper) findViewById(R.id.flipper5_10);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			switch (i) {
				case 0 : curView.setText("10. 국내의 중대산업사고의 예를 들어보라\n" +
						"89년 10월 –여천공단 ABS 압축기 폭발 (23명 사상)\n" +
						"94년 7월 – 인전 농약원료 폭발 (60명 사상)\n"); break;
			}
