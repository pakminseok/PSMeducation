 ...
 * @author Mike
 */
public class ScreenViewFlipper5_11 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper5_11(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper5_11(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview5_11, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout5_11);
		flipper = (ViewFlipper) findViewById(R.id.flipper5_11);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			switch (i) {
				case 0 : curView.setText("11. PSM 대상 사업장의 차등관리제도란 무엇인가?\n" +
						"공정안전보고서의 이해수준에 따라 P등급, S등급, M등급으로 구분한다.\n"); break;
			}
