 ...
 * @author Mike
 */
public class ScreenViewFlipper5_12 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper5_12(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper5_12(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview5_12, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout5_12);
		flipper = (ViewFlipper) findViewById(R.id.flipper5_12);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			switch (i) {
				case 0 : curView.setText("12.비상사태 발생시 취할 조치에 대하여 알고 있는가?\n" +
						"주요 비상사태에 대해서는 가상 시나리오에 의한 훈련을 통하여 대처방법을 숙지하고 있으며 엄무분장표에 의한 개인의 임부도\n" +
						"-업무분장내용\n" +
						"⓵소방조직도상의 내용상 임무 확인\n" +
						"⓶공정안전보고서상의 “비상조치계획”\n"); break;
			}
