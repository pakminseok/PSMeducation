 ...
 * @author Mike
 */
public class ScreenViewFlipper5_13 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper5_13(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper5_13(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview5_13, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout5_13);
		flipper = (ViewFlipper) findViewById(R.id.flipper5_13);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			switch (i) {
				case 0 : curView.setText("13. 용접작업시 안전조치사항 및 안전작업허가 절차에 대해 알고 있는가?\n" +
						"배관 및 용기내부에 잔류되어 있는 유기용매 제거후 화기 작업허가서를 발부받아 용접작업을 실시한다.(소화기 필히비치)\n"); break;
			}
