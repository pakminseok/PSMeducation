 ...
 * @author Mike
 */
public class ScreenViewFlipper5_14 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper5_14(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper5_14(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview5_14, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout5_14);
		flipper = (ViewFlipper) findViewById(R.id.flipper5_14);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			switch (i) {
				case 0 : curView.setText("14. 밀폐공간 출입시 안전조치사항 및 안전작업허가 절차에 대해 알고 있는가?\n" +
						"밀폐공간 출입허가서를 발급 받아 밀폐지역 산소농도(18%이상)와 오해가스농도를 측정 후 이상이 없을시 작업을 진행\n"); break;
			}
