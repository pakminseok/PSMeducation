 ...
 * @author Mike
 */
public class ScreenViewFlipper5_15 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper5_15(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper5_15(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview5_15, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout5_15);
		flipper = (ViewFlipper) findViewById(R.id.flipper5_15);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			switch (i) {
				case 0 : curView.setText("15. 방폭지역을 알고 있는가?\n" +
						"공장등의 사무실, 휴게실을 제외한 전 지역이 방폭 2종 이상 지역으로 지정되어 있음.\n"); break;
			}
