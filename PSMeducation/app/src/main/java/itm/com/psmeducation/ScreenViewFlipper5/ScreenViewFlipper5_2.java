 ...
 * @author Mike
 */
public class ScreenViewFlipper5_2 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper5_2(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper5_2(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview5_2, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout5_2);
		flipper = (ViewFlipper) findViewById(R.id.flipper5_2);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			switch (i) {
				case 0 : curView.setText("2. 공정안전보고서 등에 규정된 안전운전절차를 정확하게 숙지하고 있는가?\n" +
						"시운전, 정상 및 비상가동, 비상가동 정지, 운전안전표준등이 있으며 교육시간에 직무별로 교육을 통하여 내용을 알고 있다.\n"); break;
			}
