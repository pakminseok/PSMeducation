 ...
 * @author Mike
 */
public class ScreenViewFlipper5_3 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper5_3(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper5_3(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview5_3, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout5_3);
		flipper = (ViewFlipper) findViewById(R.id.flipper5_3);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			switch (i) {
				case 0 : curView.setText("3.공정 또는 설비가 변경된 경우 변경사항에 대한 교육을 받는가?\n" +
						"변경이 시행되기 전에 직간접적인 잠재위험을 검토하여 변경 내용을 시 운전 전에 교육을 통하여 변경내용을 알고 있다.\n" +
						"-변경요소의 범위: 공장내의 공정운전등의 절차 또는 공정설비의 변경시 해당되는 요소를 변경요소라 하며, 변경판정의 기준표에 따라 변경요소가 하나만 해당되어도 변경에 해당된다.\n"); break;
			}
