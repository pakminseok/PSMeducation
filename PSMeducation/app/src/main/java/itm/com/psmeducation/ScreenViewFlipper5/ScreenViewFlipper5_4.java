 ...
 * @author Mike
 */
public class ScreenViewFlipper5_4 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper5_4(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper5_4(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview5_4, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout5_4);
		flipper = (ViewFlipper) findViewById(R.id.flipper5_4);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			switch (i) {
				case 0 : curView.setText("4.자체감사 결과를 설명 받았는가?\n" +
						"자체감사결과 부적합 사항에 대해서는 시정조치결과서 내용에 따라 팀장 또는 안전담당자로부터 교육을 받고 있다.\n" +
						"-자체감사의 목적 : 공정안전보고서의 내용을 성실히 이행하고 있는지의 여부를 평가 확인하고 기준에 미달되는 문제점을 개선하기 위한 것이다.\n" +
						"-자체감사 주기: 년 1회\n"); break;
			}
