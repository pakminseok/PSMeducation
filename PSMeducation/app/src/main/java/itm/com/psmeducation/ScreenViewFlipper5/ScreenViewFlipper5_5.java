 ...
 * @author Mike
 */
public class ScreenViewFlipper5_5 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper5_5(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper5_5(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview5_5, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout5_5);
		flipper = (ViewFlipper) findViewById(R.id.flipper5_5);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			switch (i) {
				case 0 : curView.setText("5. 사업장내 공정사고에 대하여 알고있는가?\n" +
						"현재까지 공정사고는 발생이 없었다.\n"); break;
			}
