 ...
 * @author Mike
 */
public class ScreenViewFlipper5_6 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper5_6(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper5_6(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview5_6, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout5_6);
		flipper = (ViewFlipper) findViewById(R.id.flipper5_6);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			switch (i) {
				case 0 : curView.setText("6. 작업장에서 발생할 수 있는 사고에 대처하는 방법에 대하여 알고 있는가?\n" +
						"상황에 따라 조치해야 할 대상이 다르나 공정이 안정적으로 운전 또는 가동 정지될 수 있도록 조치를 취하는 것이다.\n"); break;
			}
