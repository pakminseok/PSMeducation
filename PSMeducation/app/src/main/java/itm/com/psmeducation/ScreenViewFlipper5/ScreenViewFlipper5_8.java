 ...
 * @author Mike
 */
public class ScreenViewFlipper5_8 extends LinearLayout implements OnTouchListener {
	...
	public ScreenViewFlipper5_8(Context context) {
		super(context);

		init(context);
	}

	public ScreenViewFlipper5_8(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void init(Context context) {
		...
		inflater.inflate(R.layout.screenview5_8, this, true);

		buttonLayout = (LinearLayout) findViewById(R.id.buttonLayout5_8);
		flipper = (ViewFlipper) findViewById(R.id.flipper5_8);
		...
		for(int i = 0; i < countIndexes; i++) {
			...
			switch (i) {
				case 0 : curView.setText("8. 안전작업 허가는 무엇인가?\n" +
						"유해 위험요소가 내재되어 있는 작업시 근로자와 설비를 보호하기 위하여 준수해야 할 방법, 절차, 책임 및 요구사항에 대해 문서로 작성되어 결재권자의 승인을 거쳐 작업이 시작부터 종료될 때까지 안전하게 수행될 수 있도록 한다.\n" +
						"-안전작업허가의 종류\n" +
						"⓵화기작업 – 용접, 용단, 화기취급 작업시\n" +
						"⓶위험작업 – 고소, 전기, 밀폐, 굴착, 중량물 작업\n"); break;
			}
